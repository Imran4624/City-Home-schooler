...
export const SavedUserCard = ({ title }) => (
  <View style={{ marginBottom: '2%', flexDirection: 'row', backgroundColor: MyTheme.primary, borderRadius: 10, borderWidth: 1, elevation: 1, overflow: 'hidden', borderColor: MyTheme.border }}>
    ...
    <View style={{ flex: 1, justifyContent: 'space-between', alignItems: 'stretch', flexDirection: 'row' }}>
      ...
      <View style={{
        ...
        alignItems: 'center', borderLeftWidth: 1, borderLeftColor: MyTheme.border
      }}>
        <Image
